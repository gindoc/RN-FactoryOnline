                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.message}>
                        ...
                        <View style={{flexDirection:'row', justifyContent:'flex-start', alignItems:'center',flex:1,}}>
                            <Text style={{fontSize:12, color:'#808080', }}>{Tags.selectTag(item.factory.tags[0].id, item.factory.tags[0].name)}</Text>
                            <Text style={{fontSize:14, color:'#808080', }}>{item.factory.price}元/㎡</Text>
                        </View>
                    </View>
